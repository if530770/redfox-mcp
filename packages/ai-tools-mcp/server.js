...
/**
 * ai-tools-mcp-server
 * AI 工具 MCP Server — DeepSeek/豆包/Kimi 联网搜索、视频生成、图片写作、视频提示词
...
const SERVER_NAME = 'ai-tools-mcp';
const SERVER_VERSION = '1.0.0';
const PROTOCOL_VERSION = '2024-11-05';
const SUPPORTED_PROTOCOLS = ['2025-06-18', '2025-03-26', '2024-11-05', '2024-10-07'];

const PLATFORM_PREFIXES = ['deepseek', 'doubao', 'kimi', 'seedance', 'visual', 'video'];
const PLATFORM_LABEL = 'AI工具';
