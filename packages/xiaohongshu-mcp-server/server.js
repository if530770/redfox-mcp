 ...
 * 小红书数据 MCP Server — 爆款笔记、标题评分、账号诊断、违禁词检测
 * 协议：MCP (Model Context Protocol) over stdio，JSON-RPC 2.0
 *
 * 启动：REDFOX_API_KEY=ak_xxx npx -y xiaohongshu-mcp-server@latest
 */
'use strict';
